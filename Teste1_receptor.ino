...
const int ploadPin        = 4;    //Conecta ao pino 1 do 74HC165 (PL - asynchronous parallel load input)(SH/LD) - D2 no ESP8266
const int clockEnablePin  = 2;    //Conecta ao pino 15 do 74HC165 (CE - Clock Enable Input)(CLK INH)            - D4 no ESP8266
const int dataPin         = 14;   //Conecta ao pino 9 do 74HC165 (Q7 - serial output from the last stage)(QH)   - D5 no ESP8266
...
const int led_wifi        = 3;    //LED que indica a conexão com o wifi                                         - RX no ESP8266
const int led_power       = 0;    //LED que indica se o sistema está energizado                                 - D3 no ESP8266
